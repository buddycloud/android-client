	...
	public PacketExtension parseExtension(XmlPullParser parser) throws Exception
	{
		...
		else
		{
	        ...
	        if (ProviderManager.getInstance().getExtensionProvider(payloadElemName, payloadNS) == null)
	        {
	    		...
	    		return new Item(id, new SimplePayload(payloadElemName, payloadNS, payloadText));
	        }
	        else
	        {
	        	return new Item(id, PacketParserUtils.parsePacketExtension(payloadElemName, payloadNS, parser));
	        }
		}
	}
