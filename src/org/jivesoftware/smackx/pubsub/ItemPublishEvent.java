...
public class ItemPublishEvent extends SubscriptionEvent
{
	 ...
	 */
	public ItemPublishEvent(String nodeId, List<Item> eventItems)
	{
		super(nodeId);
		items = eventItems;
	}
	 ...
	 */
	public ItemPublishEvent(String nodeId, List<Item> eventItems, List<String> subscriptionIds)
	{
	 ...
	 */
	public ItemPublishEvent(String nodeId, List<Item> eventItems, List<String> subscriptionIds, Date publishedDate)
	{
		super(nodeId, subscriptionIds);
		items = eventItems;
