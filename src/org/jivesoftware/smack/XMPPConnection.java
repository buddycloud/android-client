 ...
 * $RCSfile$
 * $Revision: 11227 $
 * $Date: 2009-08-29 20:48:56 +0200 (Sat, 29 Aug 2009) $
 *
        ...
        if (configuration.isDebuggerEnabled()) {
            if (debugger == null) {
                ...
                if (debuggerClass == null) {
                    try {
                        debuggerClass =
                                Class.forName("org.jivesoftware.smackx.debugger.AndroidDebugger");
                    }
                    catch (Exception ex) {
                        try {
                            debuggerClass =
                                    Class.forName("org.jivesoftware.smack.debugger.AndroidDebugger");
                        }
                        catch (Exception ex2) {
                            ex2.printStackTrace();
                        }
